...
fun <T: Element> Element.find(selector: String) = querySelector(selector) as T?
fun <T: Element> Element.findAll(selector: String) = querySelectorAll(selector).asList() as List<T>
